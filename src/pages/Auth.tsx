  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        toast({
          title: "Welcome back! 🎉",
          description: "Ready to continue your coding journey?",
        });
      } else {
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          >
            ...
            <h1 className="text-3xl font-black text-foreground">CodeQuest</h1>
          </motion.div>
          <Mascot mood="happy" size="md" />
          <p className="text-muted-foreground mt-2">
            {isLogin ? "Welcome back, coder!" : "Join the adventure!"}
          </p>
        </div>
        ...
        <p className="text-center text-xs text-muted-foreground mt-4">
          Your progress syncs to the cloud with your account.
        </p>
      </motion.div>
    </div>
  );
